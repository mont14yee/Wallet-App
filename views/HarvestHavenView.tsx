    ...
    return (
        <div className="p-4 sm:p-6 bg-transparent h-full">
            <div className="max-w-4xl mx-auto">
                ...
                {activeList ? (
                    <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-white/60 dark:border-gray-700/50 p-4 rounded-lg shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] animate-fadeIn">
