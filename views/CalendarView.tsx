...
const CalendarView: React.FC<CalendarViewProps> = ({ scheduled, loans, subscriptions }) => {
    ...
    return (
        <div className="p-4 sm:p-6 bg-transparent h-full flex flex-col lg:flex-row gap-6">
            ...
            <div className="lg:w-96 flex-shrink-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-white/60 dark:border-gray-700/50 p-4 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)]">
