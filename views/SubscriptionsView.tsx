    ...
    return (
        <div className="w-72 h-48 flex-shrink-0 perspective-1000">
            <div className={`relative w-full h-full transition-transform duration-700 transform-style-preserve-3d ${isFlipped ? 'rotate-y-180' : ''}`}>
                {/* Front */}
                <div className={`absolute w-full h-full backface-hidden p-4 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] flex flex-col justify-between overflow-hidden
                ...
                {/* Back */}
                <div className={`absolute w-full h-full backface-hidden p-4 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] flex flex-col justify-between rotate-y-180 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-white/60 dark:border-gray-700/50 border-2 ${sub.health === SubscriptionHealth.Review ? 'border-amber-400' : 'border-gray-200 dark:border-gray-700'}`}>
                    <div>
